{ ... }: {
  ...
  homebrew.casks = [
    ...
    # "calibre"                              # E-book library management       → Ks-Mac
    ...
    # "microsoft-edge"                       # Microsoft's Chromium browser    → Ks-Mac
    "microsoft-office"                       # Office productivity suite
    # "microsoft-teams"                      # Communication platform          → Ks-Mac
    "mos"                                    # Smooth scrolling utility
    # "netnewswire"                          # RSS reader                      → Ks-Mac
    ...
    # "reflex-app"                           # Universal Music Control         → Ks-Mac
    "rustdesk"                               # Remote desktop software
    "shottr"                                 # Screenshot tool
    "spotify"                                # Music streaming service
    # "steam"                                # Gaming platform
    # "telegram"                             # Messaging app                   → Ks-Mac
    "the-unarchiver"                         # Archive extraction utility
    # "thebrowsercompany-dia"                # The Browser Company's Dia       → Ks-Mac
    "visual-studio-code"                     # Source code editor
    # "warp"                                 # Modern AI-powered terminal      → Ks-Mac
  ...
  homebrew.masApps = {
    ...
    # "Brother iPrint&Scan"   = 1193539993;  # Brother printer app             → Ks-Mac
    # "Compressor"            = 424390742;   # Video encoder
    # "Developer"             = 640199958;   # Apple dev news
    # "Equinox"               = 1591510203;  # Dynamic wallpapers               → Ks-Mac
    # "Final Cut Pro"         = 424389933;   # Video editor
    # "finanzblick"           = 993109868;   # Banking app                     → Ks-Mac
    # "Flow"                  = 1423210932;  # Pomodoro timer                  → Ks-Mac
    # "Fullifier"             = 1532642909;  # Safari fullscreen video
    # "Goodnotes"             = 1444383602;  # Note-taking app                 → Ks-Mac
    ...
    # "Microsoft OneNote"     = 784801555;   # Note-taking                     → Ks-Mac
    ...
    # "Shazam"                = 897118787;   # Music identifier                → Ks-Mac
    ...
    # "Video Converter"       = 1518836004;  # Video converter                 → Ks-Mac
